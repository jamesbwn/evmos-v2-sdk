...
<<<<<<< HEAD
var FACTORY_ADDRESS = '0x3E91CeE56B1A6d16A8d60A269325bDe05C563979'; // Tyche Factory on TestNet of EVMOS
...
var INIT_CODE_HASH = '0xb50cb8b977ceec295d05ff845f69eea4b7b221b185f4bb25e020a6bbce05dc6b';
var MINIMUM_LIQUIDITY = /*#__PURE__*/JSBI.BigInt(1000); // exports for internal consumption
=======
var FACTORY_ADDRESS = '0x81BC50a2df9cE424843e3c17110E1ab1FedCD4b8' // Diffu Factory on TestNet of EVMOS
// export const FACTORY_ADDRESS = '0x6aBdDa34Fb225be4610a2d153845e09429523Cd2' // Diffu Factory on Mainnet

var INIT_CODE_HASH = '0xa192c894487128ec7b68781ed7bd7e3141d1718df9e4e051e0124b7671d9a6ef'
var MINIMUM_LIQUIDITY = /*#__PURE__*/ JSBI.BigInt(1000) // exports for internal consumption
>>>>>>> 439c3c535ab89df1cb00c2767f7e9888a3a5f0db
...
var Route = /*#__PURE__*/ (function() {
  function Route(pairs, input, output) {
    ...
    !(typeof output === 'undefined' || pairs[pairs.length - 1].involvesToken(sdkCore.wrappedCurrency(output, chainId)))
...
var Trade = /*#__PURE__*/ (function() {
  ...
  Trade.bestTradeExactIn = function bestTradeExactIn(
    ...
    var chainId = nextAmountIn.currency.isToken
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      if (
        !sdkCore.currencyEquals(pair.token0, amountIn.currency) &&
        !sdkCore.currencyEquals(pair.token1, amountIn.currency)
      )
        continue
  ...
  Trade.bestTradeExactOut = function bestTradeExactOut(
    ...
    var chainId = nextAmountOut.currency.isToken
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      if (
        !sdkCore.currencyEquals(pair.token0, amountOut.currency) &&
        !sdkCore.currencyEquals(pair.token1, amountOut.currency)
      )
        continue
      if (pair.reserve0.equalTo(ZERO) || pair.reserve1.equalTo(ZERO)) continue
      var amountIn = void 0
